...
const page = () => {
  ...
  return (
        ...
        <div className="    h-12  mt-8  border-b  ">
            <input id="name" name="name"  autoComplete="name" type='text' placeholder='user name' className="block  w-full h-full     px-3 py-1.5 text-base placeholder:text-gray-400  sm:text-sm/6 focus:outline-none bg-transparent" 
         {...register("name", {
        ...
        <p className='capitalize ms-1 mt-1 mb-3 text-red-600'>{errors.name?.message}</p>     
        <div className="    h-12  mt-8  border-b  ">
        ...
        <p className='capitalize ms-1 mt-1 mb-3 text-red-600'>{errors.email?.message}</p>     
 ...
 width="24" height="24" viewBox="0 0 24 24" fill="none">
  ...
  <path d="M12 20.27C15.53 20.27 18.82 18.19 21.11 14.59C22.01 13.18 22.01 10.81 21.11 9.4C18.82 5.8 15.53 3.72 12 3.72C8.47003 3.72 5.18003 5.8 2.89003 9.4C1.99003 10.81 1.99003 13.18 2.89003 14.59C5.18003 18.19 8.47003 20.27 12 20.27Z" stroke="white" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
                ...
                <p className='capitalize ms-1 mt-1 mb-3 text-red-600'>{errors.password?.message}</p>
                
          <div className=" flex items-center  h-12  mt-8   border-b ">
                    <input id="confirm password" name="confirm password" type={showConfirmPass ? "text" : "password"} autoComplete="confirm password" placeholder='confirm password' className="block  w-full h-full     px-3 py-1.5 text-base placeholder:text-gray-400  sm:text-sm/6 focus:outline-none bg-transparent " 
                    {...register('confirm',{required:'* confirm password is required',
                        ...
                        maxLength:{
                            value:20,
                            message: "* confirm password can't be more than 20 characters",
                        },
                        validate:(value)=>
                     ...
                     />
                                  <svg xmlns="http://www.w3.org/2000/svg"  className='cursor-pointer me-3'                 onClick={()=>setShowConfirmPass(!showConfirmPass)}
 width="24" height="24" viewBox="0 0 24 24" fill="none">
  <path d="M15.58 12C15.58 13.98 13.98 15.58 12 15.58C10.02 15.58 8.41998 13.98 8.41998 12C8.41998 10.02 10.02 8.42001 12 8.42001C13.98 8.42001 15.58 10.02 15.58 12Z" stroke="white" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
  <path d="M12 20.27C15.53 20.27 18.82 18.19 21.11 14.59C22.01 13.18 22.01 10.81 21.11 9.4C18.82 5.8 15.53 3.72 12 3.72C8.47003 3.72 5.18003 5.8 2.89003 9.4C1.99003 10.81 1.99003 13.18 2.89003 14.59C5.18003 18.19 8.47003 20.27 12 20.27Z" stroke="white" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
</svg>
                </div>
                <p className='capitalize ms-1 mt-1 mb-3 text-red-600'>{errors.confirm?.message}</p>
                

         <button type='submit' className='w-full mt-5 h-12  bg-btn '>Sign up</button>
<h1 className='text-lg  text-center mt-5 capitalize'>have an account already ? <a href='/register/login' className='underline  text-[var(--main-color)]'>Login</a></h1>
